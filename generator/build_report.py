...
ideas = [
    ...
    dict(
        badge="Prioritario",
        day="Martedì 15/9",
        format="Carosello dati (mito da sfatare — fonde vibe coding + PMI italiane)",
        title="Corsa o attesa: nessuna delle due è una strategia AI",
        news="Veracode, USENIX, IBM + Osservatori Polimi/IIA",
        news_url="https://www.superblocks.com/blog/vibe-coding-enterprise-adoption",
        hook="🔥 Il mito: con l'AI ci sono solo due strade — correre e prendersi ogni rischio, o aspettare che passi la moda. I dati di questa settimana raccontano una terza via: quella con un metodo.",
        no_hashtags=True,
        is_myth=True,
        myth_body="Due rilevazioni della settimana, lette insieme, smontano entrambe le scorciatoie.",
        points=[
            ...
            "Il 22% dei pacchetti suggeriti da AI, nella stima peggiore, non esiste: rischio «slopsquatting» (USENIX).",
            "Shadow AI non governata: una data breach costa 670.000 $ in più (IBM).",
        ],
        myth_closing="In entrambi i casi la variabile che decide l'esito non è la tecnologia: è il metodo con cui viene introdotta.",
        cta="Nella tua azienda l'AI si adotta con un metodo, o si sceglie tra «a tutta velocità» e «aspettiamo»? 👇",
        hashtags="",
    ),
    dict(
        badge="Prioritario",
...
publishing = [
    ...
    dict(
        day="Martedì 15/9",
        time="12:15",
        format="Carosello dati / mito da sfatare (vibe coding + PMI italiane)",
        reason="Finestra pausa pranzo 12:00-13:00, giorno a massimo traffico B2B. Formato documento: dopo l'aggregazione dei trend 9-10 del report, il post unisce i dati sul codice AI rischioso e sul gap delle PMI italiane in un unico carosello, invece di due post separati.",
    ),
    dict(
        day="Mercoledì 16/9",
        time="08:30",
    ...
    dict(
        day="Da programmare",
        time="—",
        format="Riserva — Riflessione di chiusura",
